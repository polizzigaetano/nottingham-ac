...
/**
 * Hero (card, dark) — full-bleed photographic banner with an opaque navy
 * card overlapping the top-left corner, containing a heading, short
 * paragraph and a single CTA. Authored as a block with a background image
 * and a content area (heading + text + button).
 * @param {Element} block
 */
export default function decorate(block) {
  ...
  if (bgPicture) {
    ...
    media.className = 'hero-card-dark-media';
    if (img) {
  ...
  content.className = 'hero-card-dark-content';
